        ...
        <div className="flex-grow px-6 md:px-12 mx-auto max-w-7xl">
            ...
            <div className="bg-gray-200 dark:bg-gray-800 rounded-md">
                ...
                <div className="mx-auto flex flex-col items-center py-12 sm:py-24">
                    <div className="h-full w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col mb-3 sm:mb-10">
                        <Skeleton className="h-12 w-3/5" />
                        <Skeleton className="h-8 w-1/5 sm:mt-5" />
                    </div>
            ...
            <main className="max-w-screen-xl mx-auto p-4 sm:p-4 md:p-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                    {[1, 2, 3, 4 ,5 , 6].map(asset => (
                        <Skeleton key={asset} className="rounded h-64 w-56" />
                    ))}
                </div>
            </main>
        </div>
